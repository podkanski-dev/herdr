...
pub fn upsert_workspace_color(content: &str, cwd: &str, color: &str) -> String {
    ...
    let replacement = format!("{key} = {}", toml_basic_string(color));

    let mut lines: Vec<String> = content.lines().map(str::to_string).collect();
    let mut in_section = false;
    let mut section_start: Option<usize> = None;

    let mut section_last: Option<usize> = None;
    ...
    for idx in 0..lines.len() {
        ...
        if trimmed.starts_with('[') && trimmed.ends_with(']') {
            ...
            if in_section {
                ...
                section_last = Some(idx);
            } else if section_start.is_some() {
                // Hit the next section header; stop tracking section lines.
                in_section = false;
            }
            continue;
        }
        if in_section {
            ...
            // Track the last line that belongs to the section.
            if !trimmed.is_empty() {
                section_last = Some(idx);
            }
        }
...
"#;
    ...
    #[test]
    fn upsert_workspace_color_creates_section_and_key() {
        let out = upsert_workspace_color("", "/home/me/proj", "blue");
        assert!(out.contains("[workspace_colors]"));
        assert!(out.contains("\"/home/me/proj\" = \"blue\""));
    }

    #[test]
    fn upsert_workspace_color_replaces_existing_key() {
        let content = "[workspace_colors]\n\"/home/me/proj\" = \"blue\"\n";
        let out = upsert_workspace_color(content, "/home/me/proj", "red");
        assert!(out.contains("\"/home/me/proj\" = \"red\""));
        assert!(!out.contains("\"blue\""));
        assert_eq!(out.matches("/home/me/proj").count(), 1);
    }

    #[test]
    fn upsert_workspace_color_escapes_quotes_and_backslashes() {
        let out = upsert_workspace_color("", "/a\\b\"c", "#abcdef");
        assert!(out.contains("\"/a\\\\b\\\"c\" = \"#abcdef\""));
    }
    ...
    #[test]
    fn upsert_workspace_color_appends_after_existing_keys() {
        let content = "[workspace_colors]\n\"/home/me/a\" = \"blue\"\n";
    ...
    #[test]
    fn upsert_workspace_color_matches_key_without_spaces() {
        let content = "[workspace_colors]\n\"/home/me/a\"=\"blue\"\n";
        let out = upsert_workspace_color(content, "/home/me/a", "red");
        assert!(out.contains("\"red\""));
        assert!(!out.contains("\"blue\""));
        assert_eq!(out.matches("/home/me/a").count(), 1);
    }

    #[test]
    fn remove_workspace_color_matches_key_without_spaces() {
        let content = "[workspace_colors]\n\"/home/me/a\"=\"blue\"\n\"/home/me/b\" = \"red\"\n";
        let out = remove_workspace_color(content, "/home/me/a");
        assert!(!out.contains("/home/me/a"));
        assert!(out.contains("/home/me/b"));
    }
}
